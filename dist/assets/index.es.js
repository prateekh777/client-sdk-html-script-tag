...
function Pn(r, t) {
  ...
  var e, n, i = function(a, u) {
    if (a == null) return {};
    var l, p, m = {}, g = Object.keys(a);
    for (p = 0; p < g.length; p++) l = g[p], u.indexOf(l) >= 0 || (m[l] = a[l]);
    return m;
  }(r, t);
  ...
  return function(e) {
    ...
    if (i != null) {
      ...
      try {
        ...
        try {
          if (!m && i.return != null && (l = i.return(), Object(l) !== l)) return;
        } finally {
          if (g) throw a;
        }
      }
...
ba.exports = V, Me.once = function(r, t) {
  return new Promise(function(e, n) {
    ...
    Vn(r, t, o, { once: !0 }), t !== "error" && function(a, u, l) {
      typeof a.on == "function" && Vn(a, "error", u, l);
    }(r, i, { once: !0 });
  });
...
function xn(r, t, e, n) {
  ...
  if (Rt(e), (o = r._events) === void 0 ? (o = r._events = /* @__PURE__ */ Object.create(null), r._eventsCount = 0) : (o.newListener !== void 0 && (r.emit("newListener", t, e.listener ? e.listener : e), o = r._events), a = o[t]), a === void 0) a = o[t] = e, ++r._eventsCount;
    ...
    l.name = "MaxListenersExceededWarning", l.emitter = r, l.type = t, l.count = a.length, u = l, console && console.warn && console.warn(u);
  }
  return r;
}
function wa() {
...
Object.defineProperty(V, "defaultMaxListeners", { enumerable: !0, get: function() {
  ...
  if (typeof u == "function") Dn(u, this, t);
    ...
    var l = u.length, p = Es(u, l);
    for (e = 0; e < l; ++e) Dn(p[e], this, t);
  }
  return !0;
...
class _ {
  ...
  static compareVersions(t, e, n = !1) {
    const i = _.getVersionPrecision(t), o = _.getVersionPrecision(e);
    let a = Math.max(i, o), u = 0;
    const l = _.map([t, e], (p) => {
      const m = a - _.getVersionPrecision(p), g = p + new Array(m + 1).join(".0");
      return _.map(g.split("."), (b) => new Array(20 - b.length).join("0") + b).reverse();
    });
...
const B = /version\/(\d+(\.?_?\d+)+)/i, Ea = [{ test: [/googlebot/i], describe(r) {
  const t = { name: "Googlebot" }, e = _.getFirstMatch(/googlebot\/(\d+(\.\d+))/i, r) || _.getFirstMatch(B, r);
  return e && (t.version = e), t;
} }, { test: [/opera/i], describe(r) {
  const t = { name: "Opera" }, e = _.getFirstMatch(B, r) || _.getFirstMatch(/(?:opera)[\s/](\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/opr\/|opios/i], describe(r) {
  const t = { name: "Opera" }, e = _.getFirstMatch(/(?:opr|opios)[\s/](\S+)/i, r) || _.getFirstMatch(B, r);
  return e && (t.version = e), t;
} }, { test: [/SamsungBrowser/i], describe(r) {
  const t = { name: "Samsung Internet for Android" }, e = _.getFirstMatch(B, r) || _.getFirstMatch(/(?:SamsungBrowser)[\s/](\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/Whale/i], describe(r) {
  const t = { name: "NAVER Whale Browser" }, e = _.getFirstMatch(B, r) || _.getFirstMatch(/(?:whale)[\s/](\d+(?:\.\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/MZBrowser/i], describe(r) {
  const t = { name: "MZ Browser" }, e = _.getFirstMatch(/(?:MZBrowser)[\s/](\d+(?:\.\d+)+)/i, r) || _.getFirstMatch(B, r);
  return e && (t.version = e), t;
} }, { test: [/focus/i], describe(r) {
  const t = { name: "Focus" }, e = _.getFirstMatch(/(?:focus)[\s/](\d+(?:\.\d+)+)/i, r) || _.getFirstMatch(B, r);
  return e && (t.version = e), t;
} }, { test: [/swing/i], describe(r) {
  const t = { name: "Swing" }, e = _.getFirstMatch(/(?:swing)[\s/](\d+(?:\.\d+)+)/i, r) || _.getFirstMatch(B, r);
  return e && (t.version = e), t;
} }, { test: [/coast/i], describe(r) {
  const t = { name: "Opera Coast" }, e = _.getFirstMatch(B, r) || _.getFirstMatch(/(?:coast)[\s/](\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/opt\/\d+(?:.?_?\d+)+/i], describe(r) {
  const t = { name: "Opera Touch" }, e = _.getFirstMatch(/(?:opt)[\s/](\d+(\.?_?\d+)+)/i, r) || _.getFirstMatch(B, r);
  return e && (t.version = e), t;
} }, { test: [/yabrowser/i], describe(r) {
  const t = { name: "Yandex Browser" }, e = _.getFirstMatch(/(?:yabrowser)[\s/](\d+(\.?_?\d+)+)/i, r) || _.getFirstMatch(B, r);
  return e && (t.version = e), t;
} }, { test: [/ucbrowser/i], describe(r) {
  const t = { name: "UC Browser" }, e = _.getFirstMatch(B, r) || _.getFirstMatch(/(?:ucbrowser)[\s/](\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/Maxthon|mxios/i], describe(r) {
  const t = { name: "Maxthon" }, e = _.getFirstMatch(B, r) || _.getFirstMatch(/(?:Maxthon|mxios)[\s/](\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/epiphany/i], describe(r) {
  const t = { name: "Epiphany" }, e = _.getFirstMatch(B, r) || _.getFirstMatch(/(?:epiphany)[\s/](\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/puffin/i], describe(r) {
  const t = { name: "Puffin" }, e = _.getFirstMatch(B, r) || _.getFirstMatch(/(?:puffin)[\s/](\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/sleipnir/i], describe(r) {
  const t = { name: "Sleipnir" }, e = _.getFirstMatch(B, r) || _.getFirstMatch(/(?:sleipnir)[\s/](\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/k-meleon/i], describe(r) {
  const t = { name: "K-Meleon" }, e = _.getFirstMatch(B, r) || _.getFirstMatch(/(?:k-meleon)[\s/](\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/micromessenger/i], describe(r) {
  const t = { name: "WeChat" }, e = _.getFirstMatch(/(?:micromessenger)[\s/](\d+(\.?_?\d+)+)/i, r) || _.getFirstMatch(B, r);
  return e && (t.version = e), t;
} }, { test: [/qqbrowser/i], describe(r) {
  const t = { name: /qqbrowserlite/i.test(r) ? "QQ Browser Lite" : "QQ Browser" }, e = _.getFirstMatch(/(?:qqbrowserlite|qqbrowser)[/](\d+(\.?_?\d+)+)/i, r) || _.getFirstMatch(B, r);
  return e && (t.version = e), t;
} }, { test: [/msie|trident/i], describe(r) {
  const t = { name: "Internet Explorer" }, e = _.getFirstMatch(/(?:msie |rv:)(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/\sedg\//i], describe(r) {
  const t = { name: "Microsoft Edge" }, e = _.getFirstMatch(/\sedg\/(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/edg([ea]|ios)/i], describe(r) {
  const t = { name: "Microsoft Edge" }, e = _.getSecondMatch(/edg([ea]|ios)\/(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/vivaldi/i], describe(r) {
  const t = { name: "Vivaldi" }, e = _.getFirstMatch(/vivaldi\/(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/seamonkey/i], describe(r) {
  const t = { name: "SeaMonkey" }, e = _.getFirstMatch(/seamonkey\/(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/sailfish/i], describe(r) {
  const t = { name: "Sailfish" }, e = _.getFirstMatch(/sailfish\s?browser\/(\d+(\.\d+)?)/i, r);
  return e && (t.version = e), t;
} }, { test: [/silk/i], describe(r) {
  const t = { name: "Amazon Silk" }, e = _.getFirstMatch(/silk\/(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/phantom/i], describe(r) {
  const t = { name: "PhantomJS" }, e = _.getFirstMatch(/phantomjs\/(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/slimerjs/i], describe(r) {
  const t = { name: "SlimerJS" }, e = _.getFirstMatch(/slimerjs\/(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/blackberry|\bbb\d+/i, /rim\stablet/i], describe(r) {
  const t = { name: "BlackBerry" }, e = _.getFirstMatch(B, r) || _.getFirstMatch(/blackberry[\d]+\/(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/(web|hpw)[o0]s/i], describe(r) {
  const t = { name: "WebOS Browser" }, e = _.getFirstMatch(B, r) || _.getFirstMatch(/w(?:eb)?[o0]sbrowser\/(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/bada/i], describe(r) {
  const t = { name: "Bada" }, e = _.getFirstMatch(/dolfin\/(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/tizen/i], describe(r) {
  const t = { name: "Tizen" }, e = _.getFirstMatch(/(?:tizen\s?)?browser\/(\d+(\.?_?\d+)+)/i, r) || _.getFirstMatch(B, r);
  return e && (t.version = e), t;
} }, { test: [/qupzilla/i], describe(r) {
  const t = { name: "QupZilla" }, e = _.getFirstMatch(/(?:qupzilla)[\s/](\d+(\.?_?\d+)+)/i, r) || _.getFirstMatch(B, r);
  return e && (t.version = e), t;
} }, { test: [/firefox|iceweasel|fxios/i], describe(r) {
  const t = { name: "Firefox" }, e = _.getFirstMatch(/(?:firefox|iceweasel|fxios)[\s/](\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/electron/i], describe(r) {
  const t = { name: "Electron" }, e = _.getFirstMatch(/(?:electron)\/(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/MiuiBrowser/i], describe(r) {
  const t = { name: "Miui" }, e = _.getFirstMatch(/(?:MiuiBrowser)[\s/](\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/chromium/i], describe(r) {
  const t = { name: "Chromium" }, e = _.getFirstMatch(/(?:chromium)[\s/](\d+(\.?_?\d+)+)/i, r) || _.getFirstMatch(B, r);
  return e && (t.version = e), t;
} }, { test: [/chrome|crios|crmo/i], describe(r) {
  const t = { name: "Chrome" }, e = _.getFirstMatch(/(?:chrome|crios|crmo)\/(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/GSA/i], describe(r) {
  const t = { name: "Google Search" }, e = _.getFirstMatch(/(?:GSA)\/(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test(r) {
  const t = !r.test(/like android/i), e = r.test(/android/i);
  return t && e;
}, describe(r) {
  const t = { name: "Android Browser" }, e = _.getFirstMatch(B, r);
  return e && (t.version = e), t;
} }, { test: [/playstation 4/i], describe(r) {
  const t = { name: "PlayStation 4" }, e = _.getFirstMatch(B, r);
  return e && (t.version = e), t;
} }, { test: [/safari|applewebkit/i], describe(r) {
  const t = { name: "Safari" }, e = _.getFirstMatch(B, r);
  return e && (t.version = e), t;
} }, { test: [/.*/i], describe(r) {
  const t = r.search("\\(") !== -1 ? /^(.*)\/(.*)[ \t]\((.*)/ : /^(.*)\/(.*) /;
  return { name: _.getFirstMatch(t, r), version: _.getSecondMatch(t, r) };
} }];
var ka = [{ test: [/Roku\/DVP/], describe(r) {
  const t = _.getFirstMatch(/Roku\/DVP-(\d+\.\d+)/i, r);
  return { name: Z.Roku, version: t };
} }, { test: [/windows phone/i], describe(r) {
  const t = _.getFirstMatch(/windows phone (?:os)?\s?(\d+(\.\d+)*)/i, r);
  return { name: Z.WindowsPhone, version: t };
} }, { test: [/windows /i], describe(r) {
  const t = _.getFirstMatch(/Windows ((NT|XP)( \d\d?.\d)?)/i, r), e = _.getWindowsVersionName(t);
  return { name: Z.Windows, version: t, versionName: e };
} }, { test: [/Macintosh(.*?) FxiOS(.*?)\//], describe(r) {
  const t = { name: Z.iOS }, e = _.getSecondMatch(/(Version\/)(\d[\d.]+)/, r);
  return e && (t.version = e), t;
} }, { test: [/macintosh/i], describe(r) {
  const t = _.getFirstMatch(/mac os x (\d+(\.?_?\d+)+)/i, r).replace(/[_\s]/g, "."), e = _.getMacOSVersionName(t), n = { name: Z.MacOS, version: t };
  return e && (n.versionName = e), n;
} }, { test: [/(ipod|iphone|ipad)/i], describe(r) {
  const t = _.getFirstMatch(/os (\d+([_\s]\d+)*) like mac os x/i, r).replace(/[_\s]/g, ".");
  return { name: Z.iOS, version: t };
} }, { test(r) {
  const t = !r.test(/like android/i), e = r.test(/android/i);
  return t && e;
}, describe(r) {
  const t = _.getFirstMatch(/android[\s/-](\d+(\.\d+)*)/i, r), e = _.getAndroidVersionName(t), n = { name: Z.Android, version: t };
  return e && (n.versionName = e), n;
} }, { test: [/(web|hpw)[o0]s/i], describe(r) {
  const t = _.getFirstMatch(/(?:web|hpw)[o0]s\/(\d+(\.\d+)*)/i, r), e = { name: Z.WebOS };
  return t && t.length && (e.version = t), e;
} }, { test: [/blackberry|\bbb\d+/i, /rim\stablet/i], describe(r) {
  const t = _.getFirstMatch(/rim\stablet\sos\s(\d+(\.\d+)*)/i, r) || _.getFirstMatch(/blackberry\d+\/(\d+([_\s]\d+)*)/i, r) || _.getFirstMatch(/\bbb(\d+)/i, r);
  return { name: Z.BlackBerry, version: t };
} }, { test: [/bada/i], describe(r) {
  const t = _.getFirstMatch(/bada\/(\d+(\.\d+)*)/i, r);
  return { name: Z.Bada, version: t };
} }, { test: [/tizen/i], describe(r) {
  const t = _.getFirstMatch(/tizen[/\s](\d+(\.\d+)*)/i, r);
  ...
  const t = _.getFirstMatch(/PlayStation 4[/\s](\d+(\.\d+)*)/i, r);
  return { name: Z.PlayStation4, version: t };
} }], Ca = [{ test: [/googlebot/i], describe: () => ({ type: "bot", vendor: "Google" }) }, { test: [/huawei/i], describe(r) {
  const t = _.getFirstMatch(/(can-l01)/i, r) && "Nova", e = { type: W.mobile, vendor: "Huawei" };
  ...
  const t = _.getFirstMatch(/(ipod|iphone)/i, r);
  ...
  const t = { name: Le.Trident }, e = _.getFirstMatch(/trident\/(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: (r) => r.test(/presto/i), describe(r) {
  const t = { name: Le.Presto }, e = _.getFirstMatch(/presto\/(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test(r) {
  const t = r.test(/gecko/i), e = r.test(/like gecko/i);
  return t && !e;
}, describe(r) {
  const t = { name: Le.Gecko }, e = _.getFirstMatch(/gecko\/(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }, { test: [/(apple)?webkit\/537\.36/i], describe: () => ({ name: Le.Blink }) }, { test: [/(apple)?webkit/i], describe(r) {
  const t = { name: Le.WebKit }, e = _.getFirstMatch(/webkit\/(\d+(\.?_?\d+)+)/i, r);
  return e && (t.version = e), t;
} }];
class Jn {
  constructor(t, e = !1) {
  ...
  satisfies(t) {
    ...
    if (Object.keys(t).forEach((a) => {
      ...
      const a = Object.keys(e), u = _.find(a, (p) => this.isOS(p));
      if (u) {
        const p = this.satisfies(e[u]);
        if (p !== void 0) return p;
      }
      const l = _.find(a, (p) => this.isPlatform(p));
      if (l) {
        const p = this.satisfies(e[l]);
        if (p !== void 0) return p;
      }
    }
    if (o > 0) {
      const a = Object.keys(i), u = _.find(a, (l) => this.isBrowser(l, !0));
  ...
  isBrowser(t, e = !1) {
    ...
    let i = t.toLowerCase();
    const o = _.getBrowserTypeByAlias(i);
    return e && o && (i = o.toLowerCase()), i === n;
  }
  compareVersion(t) {
    let e = [0], n = t, i = !1;
    const o = this.getBrowserVersion();
    if (typeof o == "string") return t[0] === ">" || t[0] === "<" ? (n = t.substr(1), t[1] === "=" ? (i = !0, n = t.substr(2)) : e = [], t[0] === ">" ? e.push(1) : e.push(-1)) : t[0] === "=" ? n = t.substr(1) : t[0] === "~" && (i = !0, n = t.substr(1)), e.indexOf(_.compareVersions(o, n, i)) > -1;
  }
  isOS(t) {
...
function Oa(r, t, e = 250, n, i, o, a) {
  ...
  var l, p;
  u && (o.exception.values = (l = Tr(r, t, i, a.originalException, n, o.exception.values, u, 0), p = e, l.map((m) => (m.value && (m.value = nt(m.value, p)), m))));
}
function Tr(r, t, e, n, i, o, a, u) {
  ...
  if (Qe(n[i], Error)) {
    Wn(a, u);
    const p = r(t, n[i]), m = l.length;
    zn(p, i, m, u), l = Tr(r, t, e, n[i], i, [p, ...l], p, m);
  }
  return Array.isArray(n.errors) && n.errors.forEach((p, m) => {
    if (Qe(p, Error)) {
      Wn(a, u);
      const g = r(t, p), b = l.length;
      zn(g, `errors[${m}]`, b, u), l = Tr(r, t, e, p, i, [g, ...l], g, b);
    }
  }), l;
}
function Wn(r, t) {
...
const He = "8.33.1", F = globalThis;
function Gt(r, t, e) {
  const n = F, i = n.__SENTRY__ = n.__SENTRY__ || {}, o = i[He] = i[He] || {};
  return o[r] || (o[r] = t());
}
const nn = F;
function Os(r, t = {}) {
  ...
  try {
    ...
    for (; e && o++ < n && (p = Pa(e, m), !(p === "html" || o > 1 && a + i.length * l + p.length >= g)); ) i.push(p), a += p.length, e = e.parentNode;
...
function Wt(r, t = !1) {
  const { host: e, path: n, pass: i, port: o, projectId: a, protocol: u, publicKey: l } = r;
  return `${u}://${l}${t && i ? `:${i}` : ""}@${e}${o ? `:${o}` : ""}/${n && `${n}/`}${a}`;
}
function Qn(r) {
...
function Ia(r) {
  const t = typeof r == "string" ? function(e) {
    ...
    const [i, o, a = "", u = "", l = "", p = ""] = n.slice(1);
    let m = "", g = p;
    const b = g.split("/");
    if (b.length > 1 && (m = b.slice(0, -1).join("/"), g = b.pop()), g) {
      const w = g.match(/^\d+/);
      w && (g = w[0]);
    }
    return Qn({ host: u, pass: a, path: m, projectId: g, port: l, protocol: i, publicKey: o });
  }(r) : Qn(r);
  if (t && function(e) {
    if (!St) return !0;
...
function Na(r, t) {
  const e = "fetch";
  We(e, r), ze(e, () => function(n, i = !1) {
    i && !Da() || ne(F, "fetch", function(o) {
      return function(...a) {
        const { method: u, url: l } = function(g) {
          ...
          const b = g[0];
          return { url: ii(b), method: Pr(b, "method") ? String(b.method).toUpperCase() : "GET" };
        }(a), p = { args: a, fetchData: { method: u, url: l }, startTimestamp: 1e3 * Re() };
        de("fetch", { ...p });
...
function Ir(r, t, e = 1 / 0, n = 1 / 0, i = /* @__PURE__ */ function() {
  ...
  return [function(u) {
    ...
    for (let l = 0; l < a.length; l++) if (a[l] === u) return !0;
    return a.push(u), !1;
  }, function(u) {
    if (o) a.delete(u);
    else for (let l = 0; l < a.length; l++) if (a[l] === u) {
      a.splice(l, 1);
      break;
    }
  }];
  ...
  const b = Ls(t);
  for (const w in b) {
    if (!Object.prototype.hasOwnProperty.call(b, w)) continue;
    if (g >= n) {
      m[w] = "[MaxProperties ~]";
      break;
    }
    const y = b[w];
    m[w] = Ir(w, y, l - 1, n, i), g++;
  }
  return a(t), m;
}
var Ce;
...
function Fa(r) {
  ...
  return { $: t, add: function(n) {
    if (!(r === void 0 || t.length < r)) return zt(new _e("Not adding Promise because buffer limit was reached."));
    const i = n();
  ...
  const t = function(n) {
    if (!(!n || !Ae(n) && !Array.isArray(n)))
      return Array.isArray(n) ? n.reduce((i, o) => {
        const a = oi(o);
        return Object.entries(a).forEach(([u, l]) => {
          i[u] = l;
        }), i;
      }, {}) : oi(n);
  }(r);
...
`), typeof u == "string" || u instanceof Uint8Array) i(u);
  ...
  return typeof n == "string" ? n : function(o) {
    ...
    let l = 0;
    for (const p of o) u.set(p, l), l += p.length;
    return u;
  }(n);
}
function Ga(r) {
...
function Wa(r, { statusCode: t, headers: e }, n = Date.now()) {
  ...
  if (o) for (const u of o.trim().split(",")) {
    const [l, p, , , m] = u.split(":", 5), g = parseInt(l, 10), b = 1e3 * (isNaN(g) ? 60 : g);
    if (p) for (const w of p.split(";")) w === "metric_bucket" && m && !m.split(";").includes("custom") || (i[w] = n + b);
    else i.all = n + b;
  }
  else a ? i.all = n + function(u, l = Date.now()) {
    const p = parseInt(`${u}`, 10);
    if (!isNaN(p)) return 1e3 * p;
    const m = Date.parse(`${u}`);
    return isNaN(m) ? 6e4 : m - l;
...
class cn {
  ...
  update(t) {
    if (!t) return this;
    const e = typeof t == "function" ? t(this) : t, [n, i] = e instanceof qe ? [e.getScopeData(), e.getRequestSession()] : ot(e) ? [t, t.requestSession] : [], { tags: o, extra: a, user: u, contexts: l, level: p, fingerprint: m = [], propagationContext: g } = n || {};
    return this._tags = { ...this._tags, ...o }, this._extra = { ...this._extra, ...a }, this._contexts = { ...this._contexts, ...l }, u && Object.keys(u).length && (this._user = u), p && (this._level = p), m.length && (this._fingerprint = m), g && (this._propagationContext = g), i && (this._requestSession = i), this;
  }
  clear() {
...
function at() {
  const r = an(sr());
  return r.stack = r.stack || new za(Gt("defaultCurrentScope", () => new qe()), Gt("defaultIsolationScope", () => new qe()));
}
function Ha(r) {
...
function ln(r) {
  const t = an(r);
  return t.acs ? t.acs : { withIsolationScope: pi, withScope: Ha, withSetScope: Qa, withSetIsolationScope: (e, n) => pi(n), getCurrentScope: () => at().getScope(), getIsolationScope: () => at().getIsolationScope() };
}
function un() {
...
function Xa(r) {
  const { spanId: t, traceId: e } = r.spanContext(), { parent_span_id: n } = Ht(r);
...
function Ht(r) {
  ...
  try {
    ...
    if (function(n) {
      ...
      const { attributes: n, startTime: i, name: o, endTime: a, parentSpanId: u, status: l } = r;
      return ue({ span_id: t, trace_id: e, data: n, description: o, parent_span_id: u, start_timestamp: hi(i), timestamp: hi(a) || void 0, status: Za(l), op: n["sentry.op"], origin: n["sentry.origin"], _metrics_summary: Ka(r) });
    }
...
function ec(r) {
  const t = te();
  if (!t) return {};
  const e = Fs(Ht(r).trace_id || "", t), n = Rs(r), i = n._frozenDsc;
  if (i) return i;
  const o = n.spanContext().traceState, a = o && o.get("sentry.dsc"), u = a && Ua(a);
  if (u) return u;
  const l = Ht(n), p = l.data || {}, m = p["sentry.sample_rate"];
  m != null && (e.sample_rate = `${m}`);
  const g = p["sentry.source"], b = l.description;
  return g !== "url" && b && (e.transaction = b), function(w) {
...
function tc(r, t, e, n) {
  ...
  (function(u, l) {
    l && (u.sdk = u.sdk || {}, u.sdk.name = u.sdk.name || l.name, u.sdk.version = u.sdk.version || l.version, u.sdk.integrations = [...u.sdk.integrations || [], ...l.integrations || []], u.sdk.packages = [...u.sdk.packages || [], ...l.packages || []]);
  })(r, e && e.sdk);
  const a = function(u, l, p, m) {
    const g = u.sdkProcessingMetadata && u.sdkProcessingMetadata.dynamicSamplingContext;
    return { event_id: u.event_id, sent_at: (/* @__PURE__ */ new Date()).toISOString(), ...l && { sdk: l }, ...!!p && m && { dsn: Wt(m) }, ...g && { trace: ue({ ...g }) } };
  }(r, i, n, t);
...
function Rr(r, t, e, n = 0) {
  return new se((i, o) => {
    ...
    if (t === null || typeof a != "function") i(t);
      ...
      const u = a({ ...t }, e);
      G && a.id && u === null && L.log(`Event processor "${a.id}" dropped event`), ir(u) ? u.then((l) => Rr(r, l, e, n + 1).then(i)).then(null, o) : Rr(r, u, e, n + 1).then(i).then(null, o);
    }
  });
}
function rc(r, t) {
  ...
  (function(a, u) {
    const { extra: l, tags: p, user: m, contexts: g, level: b, transactionName: w } = u, y = ue(l);
    ...
    const O = ue(g);
    O && Object.keys(O).length && (a.contexts = { ...O, ...a.contexts }), b && (a.level = b), w && a.type !== "transaction" && (a.transaction = w);
  })(r, t), n && function(a, u) {
    a.contexts = { trace: Xa(u), ...a.contexts }, a.sdkProcessingMetadata = { dynamicSamplingContext: ec(u), ...a.sdkProcessingMetadata };
    const l = Rs(u), p = Ht(l).description;
    p && !a.transaction && a.type === "transaction" && (a.transaction = p);
  }(r, n), function(a, u) {
    a.fingerprint = a.fingerprint ? function(l) {
      return Array.isArray(l) ? l : [l];
    }(a.fingerprint) : [], u && (a.fingerprint = a.fingerprint.concat(u)), a.fingerprint && !a.fingerprint.length && delete a.fingerprint;
  }(r, e), function(a, u) {
    const l = [...a.breadcrumbs || [], ...u];
    a.breadcrumbs = l.length ? l : void 0;
  }(r, i), function(a, u) {
    a.sdkProcessingMetadata = { ...a.sdkProcessingMetadata, ...u };
  }(r, o);
}
function mi(r, t) {
  const { extra: e, tags: n, user: i, contexts: o, level: a, sdkProcessingMetadata: u, breadcrumbs: l, fingerprint: p, eventProcessors: m, attachments: g, propagationContext: b, transactionName: w, span: y } = t;
  ht(r, "extra", e), ht(r, "tags", n), ht(r, "user", i), ht(r, "contexts", o), ht(r, "sdkProcessingMetadata", u), a && (r.level = a), w && (r.transactionName = w), y && (r.span = y), l.length && (r.breadcrumbs = [...r.breadcrumbs, ...l]), p.length && (r.fingerprint = [...r.fingerprint, ...p]), m.length && (r.eventProcessors = [...r.eventProcessors, ...m]), g.length && (r.attachments = [...r.attachments, ...g]), r.propagationContext = { ...r.propagationContext, ...b };
}
function ht(r, t, e) {
...
function nc(r, t, e, n, i, o) {
  const { normalizeDepth: a = 3, normalizeMaxBreadth: u = 1e3 } = r, l = { ...t, event_id: t.event_id || e.event_id || pe(), timestamp: t.timestamp || Et() }, p = e.integrations || r.integrations.map((y) => y.name);
  (function(y, E) {
    ...
    const z = y.exception && y.exception.values && y.exception.values[0];
    z && z.value && (z.value = nt(z.value, x));
    const Y = y.request;
    Y && Y.url && (Y.url = nt(Y.url, x));
  })(l, r), function(y, E) {
    E.length > 0 && (y.sdk = y.sdk || {}, y.sdk.integrations = [...y.sdk.integrations || [], ...E]);
  }(l, p), i && i.emit("applyFrameMetadata", t), t.type === void 0 && function(y, E) {
    const C = F._sentryDebugIds;
    if (!C) return;
    let O;
    const j = gi.get(E);
    j ? O = j : (O = /* @__PURE__ */ new Map(), gi.set(E, O));
    const x = Object.entries(C).reduce((z, [Y, ae]) => {
      let ie;
      const ge = O.get(Y);
  ...
  e.mechanism && bt(l, e.mechanism);
  const g = i ? i.getEventProcessors() : [], b = Gt("globalScope", () => new qe()).getScopeData();
  o && mi(b, o.getScopeData()), m && mi(b, m.getScopeData());
  const w = [...e.attachments || [], ...b.attachments];
  return w.length && (e.attachments = w), rc(l, b), Rr([...g, ...b.eventProcessors], l, e).then((y) => (y && function(E) {
    const C = {};
    try {
...
class sc {
  constructor(t) {
    if (this._options = t, this._integrations = {}, this._numProcessing = 0, this._outcomes = {}, this._hooks = {}, this._eventProcessors = [], t.dsn ? this._dsn = Ia(t.dsn) : G && L.warn("No DSN provided, client will not send events."), this._dsn) {
      const o = (e = this._dsn, n = t.tunnel, i = t._metadata ? t._metadata.sdk : void 0, n || `${function(a) {
        return `${function(u) {
          const l = u.protocol ? `${u.protocol}:` : "", p = u.port ? `:${u.port}` : "";
          return `${l}//${u.host}${p}${u.path ? `/${u.path}` : ""}/api/`;
  ...
  captureMessage(t, e, n, i) {
    ...
    return this._process(u.then((l) => this._captureEvent(l, o, i))), o.event_id;
  }
  captureEvent(t, e, n) {
    const i = pe();
  ...
  _prepareEvent(t, e, n, i = Ns()) {
    ...
    return !e.integrations && a.length > 0 && (e.integrations = a), this.emit("preprocessEvent", t, e), t.type || i.setLastEventId(t.event_id || e.event_id), nc(o, t, e, n, this, i).then((u) => {
      if (u === null) return u;
      const l = { ...i.getPropagationContext(), ...n ? n.getPropagationContext() : void 0 };
      if (!(u.contexts && u.contexts.trace) && l) {
        const { traceId: p, spanId: m, parentSpanId: g, dsc: b } = l;
  ...
  _processEvent(t, e, n) {
    const i = this.getOptions(), { sampleRate: o } = i, a = Ei(t), u = Si(t), l = t.type || "error", p = `before send for type \`${l}\``, m = o === void 0 ? void 0 : function(w) {
    ...
    if (u && typeof m == "number" && Math.random() > m) return this.recordDroppedEvent("sample_rate", "error", t), zt(new _e(`Discarding event because it's not included in the random sample (sampling rate = ${o})`, "log"));
    const g = l === "replay_event" ? "replay" : l, b = (t.sdkProcessingMetadata || {}).capturedSpanIsolationScope;
    return this._prepareEvent(t, e, n, b).then((w) => {
      ...
      const y = function(E, C, O, j) {
        const { beforeSend: x, beforeSendTransaction: z, beforeSendSpan: Y } = C;
...
function oc(r, t, e = Fa(r.bufferSize || 64)) {
  ...
  return { send: function(i) {
    ...
    const a = wt(i[0], o), u = (l) => {
      ai(a, (p, m) => {
        const g = ki(p, m);
        r.recordDroppedEvent(l, ci(m), g);
      });
    };
    return e.add(() => t({ body: Ja(a) }).then((l) => (l.statusCode !== void 0 && (l.statusCode < 200 || l.statusCode >= 300) && G && L.warn(`Sentry responded with status code ${l.statusCode} to sent event.`), n = Wa(n, l), l), (l) => {
      throw u("network_error"), l;
    })).then((l) => l, (l) => {
      if (l instanceof _e) return G && L.error("Skipped sending event because buffer is full."), u("queue_overflow"), Xe({});
      throw l;
    });
  }, flush: (i) => e.drain(i) };
}
...
const Ti = /* @__PURE__ */ new WeakMap(), cc = () => ({ name: "FunctionToString", setupOnce() {
  ...
  return function(a, u) {
    return u.ignoreInternal && function(l) {
      try {
        return l.exception.values[0].type === "SentryError";
      } catch {
      }
      return !1;
    }(a) ? (G && L.warn(`Event dropped due to being internal Sentry Error.
Event: ${je(a)}`), !0) : function(l, p) {
      return l.type || !p || !p.length ? !1 : function(m) {
        const g = [];
        m.message && g.push(m.message);
        let b;
        try {
          b = m.exception.values[m.exception.values.length - 1];
        } catch {
        }
        return b && b.value && (g.push(b.value), b.type && g.push(`${b.type}: ${b.value}`)), g;
      }(l).some((m) => Ct(m, p));
    }(a, u.ignoreErrors) ? (G && L.warn(`Event dropped due to being matched by \`ignoreErrors\` option.
Event: ${je(a)}`), !0) : function(l) {
      return l.type || !l.exception || !l.exception.values || l.exception.values.length === 0 ? !1 : !l.message && !l.exception.values.some((p) => p.stacktrace || p.type && p.type !== "Error" || p.value);
    }(a) ? (G && L.warn(`Event dropped due to not having an error message, error type or stacktrace.
Event: ${je(a)}`), !0) : function(l, p) {
      if (l.type !== "transaction" || !p || !p.length) return !1;
      const m = l.transaction;
      return !!m && Ct(m, p);
  ...
  const n = function() {
    ...
    try {
      ...
      throw xr++, setTimeout(() => {
        ...
        if (a.length === 2) {
          const [l, p] = a;
          return l ? u.withSetScope(l, p) : u.withScope(p);
        }
        u.withScope(a[0]);
      }((a) => {
        var u;
        a.addEventProcessor((l) => (t.mechanism && (Lr(l, void 0), bt(l, t.mechanism)), l.extra = { ...l.extra, arguments: i }, l)), u = o, un().captureException(u, void 0);
      }), o;
    }
  };
  try {
...
function pc(r, t, e, n) {
  ...
  const l = { exception: { values: [{ type: nr(t) ? t.constructor.name : n ? "UnhandledRejection" : "Error", value: mc(t, { isUnhandledRejection: n }) }] }, extra: u };
  if (e) {
    const p = hn(r, e);
...
function Fr(r, t, e, n, i) {
  ...
  if (Gn(t) || lt(t, "DOMException")) {
    ...
    if ("stack" in t) o = dr(r, t);
      ...
      const u = a.name || (Gn(a) ? "DOMError" : "DOMException"), l = a.message ? `${u}: ${a.message}` : u;
      o = qr(r, l, e, n), Lr(o, l);
    }
...
function mc(r, { isUnhandledRejection: t }) {
  const e = function(i, o = 40) {
    ...
    for (let l = a.length; l > 0; l--) {
      const p = a.slice(0, l).join(", ");
      if (!(p.length > o)) return l === a.length ? p : nt(p, o);
    }
    return "";
...
class gc extends sc {
  constructor(t) {
    ...
    (function(n, i, o = [i], a = "npm") {
      const u = n._metadata || {};
      u.sdk || (u.sdk = { name: `sentry.javascript.${i}`, packages: o.map((l) => ({ name: `${a}:@sentry/${l}`, version: He })), version: He }), n._metadata = u;
  ...
  eventFromMessage(t, e = "info", n) {
    return function(i, o, a = "info", u, l) {
      const p = qr(i, o, u && u.syntheticException || void 0, l);
    ...
    n && n.hasOwnProperty && n.hasOwnProperty("addEventListener") && (ne(n, "addEventListener", function(i) {
      return function(o, a, u) {
        if (o === "click" || o == "keypress") try {
          const l = this, p = l.__sentry_instrumentation_handlers__ = l.__sentry_instrumentation_handlers__ || {}, m = p[o] = p[o] || { refCount: 0 };
          if (!m.handler) {
            const g = Ii(r);
      ...
      return function(o, a, u) {
        if (o === "click" || o == "keypress") try {
          const l = this, p = l.__sentry_instrumentation_handlers__ || {}, m = p[o];
          m && (m.refCount--, m.refCount <= 0 && (i.call(this, o, m.handler, u), m.handler = void 0, delete p[o]), Object.keys(p).length === 0 && delete l.__sentry_instrumentation_handlers__);
        } catch {
        }
        return i.call(this, o, a, u);
      };
...
function bc() {
  ...
  r.open = new Proxy(r.open, { apply(t, e, n) {
    const i = 1e3 * Re(), o = Ae(n[0]) ? n[0].toUpperCase() : void 0, a = function(l) {
      if (Ae(l)) return l;
      try {
        return l.toString();
      } catch {
    ...
    return "onreadystatechange" in e && typeof e.onreadystatechange == "function" ? e.onreadystatechange = new Proxy(e.onreadystatechange, { apply: (l, p, m) => (u(), l.apply(p, m)) }) : e.addEventListener("readystatechange", u), e.setRequestHeader = new Proxy(e.setRequestHeader, { apply(l, p, m) {
      const [g, b] = m, w = p[mt];
      return w && Ae(g) && Ae(b) && (w.request_headers[g.toLowerCase()] = b), l.apply(p, m);
    } }), t.apply(e, n);
...
function wc(r, t = function(e) {
  ...
  return oc(r, function(i) {
    ...
    if (!t) return ji("fetch"), zt("No fetch implementation available");
    try {
...
`);
    for (let u = n; u < a.length; u++) {
      ...
      const p = Zn.test(l) ? l.replace(Zn, "$1") : l;
      if (!p.match(/\S*Error: /)) {
        for (const m of t) {
          const g = m(p);
          if (g) {
    ...
    return function(u) {
      ...
      return /sentryWrapped/.test(Tt(l).function || "") && l.pop(), l.reverse(), ei.test(Tt(l).function || "") && (l.pop(), ei.test(Tt(l).function || "") && l.pop()), l.slice(0, 50).map((p) => ({ ...p, filename: p.filename || Tt(l).filename, function: p.function || Ye }));
    }(o.slice(i));
  };
}([30, (r) => {
  const t = Sc.exec(r);
  ...
  return { name: "Breadcrumbs", setup(e) {
    ...
    t.console && function(i) {
      ...
      return function(a) {
        if (te() !== i) return;
        let u, l, p = typeof o == "object" ? o.serializeAttribute : void 0, m = typeof o == "object" && typeof o.maxStringLength == "number" ? o.maxStringLength : void 0;
        ...
        try {
          const b = a.event, w = function(y) {
            return !!y && !!y.target;
          }(b) ? b.target : b;
          u = Os(w, { keyAttrs: p, maxStringLength: m }), l = function(y) {
        ...
        l && (g.data = { "ui.component_name": l }), Be(g, { event: a.event, name: a.name, global: a.global });
      };
    }(e, t.dom), We("dom", n), ze("dom", yc)), t.xhr && function(i) {
      We("xhr", i), ze("xhr", bc);
    }(/* @__PURE__ */ function(i) {
      return function(o) {
        if (te() !== i) return;
        const { startTimestamp: a, endTimestamp: u } = o, l = o.xhr[mt];
        if (!a || !u || !l) return;
        const { method: p, url: m, status_code: g, body: b } = l, w = { method: p, url: m, status_code: g }, y = { xhr: o.xhr, input: b, startTimestamp: a, endTimestamp: u };
        Be({ category: "xhr", data: w, type: "http", level: Hn(g) }, y);
      };
      ...
      return function(o) {
        ...
        if (u && (!o.fetchData.url.match(/sentry_key/) || o.fetchData.method !== "POST")) if (o.error)
          ...
          const l = o.response, p = { ...o.fetchData, status_code: l && l.status }, m = { input: o.args, response: l, startTimestamp: a, endTimestamp: u };
          Be({ category: "fetch", data: p, type: "http", level: Hn(p.status_code) }, m);
        }
      };
      ...
      return function(o) {
        if (te() !== i) return;
        let a = o.from, u = o.to;
        const l = ur(Q.location.href);
        let p = a ? ur(a) : void 0;
        const m = ur(u);
        p && p.path || (p = l), l.protocol === m.protocol && l.host === m.host && (u = m.relative), l.protocol === p.protocol && l.host === p.host && (a = p.relative), Be({ category: "navigation", data: { from: a, to: u } });
      };
  ...
  return { name: "GlobalHandlers", setupOnce() {
    ...
    t.onerror && (function(n) {
      (function(i) {
        ...
        if (te() !== n || Pi()) return;
        const { msg: u, url: l, line: p, column: m, error: g } = i, b = function(w, y, E, C) {
          const O = w.exception = w.exception || {}, j = O.values = O.values || [], x = j[0] = j[0] || {}, z = x.stacktrace = x.stacktrace || {}, Y = z.frames = z.frames || [], ae = isNaN(parseInt(C, 10)) ? void 0 : C, ie = isNaN(parseInt(E, 10)) ? void 0 : E, ge = Ae(y) && y.length > 0 ? y : function() {
            try {
        ...
        }(Fr(o, g || u, void 0, a, !1), l, p, m);
        b.level = "error", vi(b, { originalException: g, mechanism: { handled: !1, type: "onerror" } });
      });
      ...
      (function(i) {
        ...
        const u = function(p) {
          ...
          return p;
        }(i), l = Cr(u) ? { exception: { values: [{ type: "UnhandledRejection", value: `Non-Error promise rejection captured with value: ${String(u)}` }] } } : Fr(o, u, void 0, a, !0);
        l.level = "error", vi(l, { originalException: u, mechanism: { handled: !1, type: "onunhandledrejection" } });
      });
...
function yr(r) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2 ? zi(Object(e), !0).forEach(function(n) {
      Te(r, n, e[n]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(r, Object.getOwnPropertyDescriptors(e)) : zi(Object(e)).forEach(function(n) {
  ...
  return me(t, [{ key: "addListenerForMessagesFromCallMachine", value: function(e, n, i) {
    var o = this, a = function(u) {
      if (u.data && u.data.what === "iframe-call-message" && (!u.data.callClientId || u.data.callClientId === n) && (!u.data.from || u.data.from !== "module")) {
        var l = yr({}, u.data);
        if (delete l.from, l.callbackStamp && o._messageCallbacks[l.callbackStamp]) {
          var p = l.callbackStamp;
          o._messageCallbacks[p].call(i, l), delete o._messageCallbacks[p];
        }
        delete l.what, delete l.callbackStamp, e.call(i, l);
      }
    };
    ...
    var l = o ? o.contentWindow : window, p = this._callMachineTargetOrigin(o);
    p && l.postMessage(a, p);
...
var fl = function() {
  ...
  return me(t, [{ key: "addListenerForMessagesFromCallMachine", value: function(e, n, i) {
    ...
    this._wrappedListeners[e] = l, n.addListener("message", l);
  } }, { key: "_sendMessage", value: function(e, n, i, o, a) {
    var u = function(p) {
      for (var m = 1; m < arguments.length; m++) {
        var g = arguments[m] != null ? arguments[m] : {};
        m % 2 ? Hi(Object(g), !0).forEach(function(b) {
          Te(p, b, g[b]);
        }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(p, Object.getOwnPropertyDescriptors(g)) : Hi(Object(g)).forEach(function(b) {
    ...
    if (u.callClientId = i, o) {
      var l = rr();
      this._messageCallbacks[l] = o, u.callbackStamp = l;
    }
    n.emit("message", u);
  } }]), t;
}(), Hr = "replace", Qr = "shallow-merge", Qi = [Hr, Qr], ml = function() {
  function r() {
    var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, e = t.data, n = t.mergeStrategy, i = n === void 0 ? Hr : n;
...
var vl = function() {
  ...
  return me(r, [{ key: "start", value: (i = P(function* () {
    ...
    try {
      var u = this._refetchHeaders ? { headers: this._refetchHeaders } : {}, l = yield fetch(o, u);
      if (clearTimeout(this._networkTimeout), this.cancelled || this._networkTimedOut) throw new _r();
      var p = yield this._getBundleCodeFromResponse(o, l);
      if (this.cancelled) throw new _r();
      Function('"use strict";' + p)(), this._iosCache && this._iosCache.set(o, p, l.headers), this.succeeded = !0, this._successCallback();
    } catch (m) {
...
function Zi(r, t) {
  for (var e = t.getState(), n = 0, i = ["cam", "screen"]; n < i.length; n++) for (var o = i[n], a = 0, u = ["video", "audio"]; a < u.length; a++) {
    var l = u[a], p = o === "cam" ? l : "screen".concat(l.charAt(0).toUpperCase() + l.slice(1)), m = r.tracks[p];
    if (m) {
      var g = r.local ? wl(e, o, l) : tt(e, r.session_id, o, l);
  ...
  if (r.local) {
    ...
    try {
      ...
      if (r.screen && jt(n, r.session_id, "screen-audio")) {
        var l = tt(n, r.session_id, "screen", "audio");
        l && (t && t.screenAudioTrack && t.screenAudioTrack.id === l.id ? r.screenAudioTrack = l : l.muted || (r.screenAudioTrack = l));
      }
...
function Tl(r, t) {
  ...
  if (!e) {
    if (Array.isArray(r) || (e = function(l, p) {
      if (l) {
        if (typeof l == "string") return rs(l, p);
        ...
        if (m === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(m)) return rs(l, p);
      }
    }(r)) || t) {
      e && (r = e);
      var n = 0, i = function() {
...
function Ml(r, t) {
  ...
  if (!e) {
    if (Array.isArray(r) || (e = function(l, p) {
      if (l) {
        if (typeof l == "string") return ns(l, p);
        var m = Object.prototype.toString.call(l).slice(8, -1);
        if (m === "Object" && l.constructor && (m = l.constructor.name), m === "Map" || m === "Set") return Array.from(l);
        if (m === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(m)) return ns(l, p);
      }
    }(r)) || t) {
      e && (r = e);
      var n = 0, i = function() {
    ...
    be.has(t) || (be.set(t, {}), navigator.mediaDevices.enumerateDevices().then(function(e) {
      be.has(t) && (be.get(t).lastDevicesString = JSON.stringify(e), it || (it = function() {
        var n = P(function* () {
          ...
          try {
            for (a.s(); !(i = a.n()).done; ) {
              var u = i.value, l = JSON.stringify(o);
              l !== be.get(u).lastDevicesString && (be.get(u).lastDevicesString = l, u(o));
            }
          } catch (p) {
            a.e(p);
          } finally {
...
function ss(r, t) {
  ...
  if (!e) {
    if (Array.isArray(r) || (e = function(l, p) {
      if (l) {
        if (typeof l == "string") return os(l, p);
        var m = Object.prototype.toString.call(l).slice(8, -1);
        if (m === "Object" && l.constructor && (m = l.constructor.name), m === "Map" || m === "Set") return Array.from(l);
        if (m === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(m)) return os(l, p);
      }
    }(r)) || t) {
      e && (r = e);
      var n = 0, i = function() {
...
var Je = {}, as = "video", Nl = "voice", cs = R() ? { data: {} } : { data: {}, topology: "none" }, ls = { present: 0, hidden: 0 }, Ho = { maxBitrate: { min: 1e5, max: 25e5 }, maxFramerate: { min: 1, max: 30 }, scaleResolutionDownBy: { min: 1, max: 8 } }, br = Object.keys(Ho), us = ["state", "volume", "simulcastEncodings"], ds = { androidInCallNotification: { title: "string", subtitle: "string", iconName: "string", disableForCustomOverride: "boolean" }, disableAutoDeviceManagement: { audio: "boolean", video: "boolean" } }, Zt = { id: { iconPath: "string", iconPathDarkMode: "string", label: "string", tooltip: "string", visualState: "'default' | 'sidebar-open' | 'active'" } }, Zr = { id: { allow: "string", controlledBy: "'*' | 'owners' | string[]", csp: "string", iconURL: "string", label: "string", loading: "'eager' | 'lazy'", location: "'main' | 'sidebar'", name: "string", referrerPolicy: "string", sandbox: "string", src: "string", srcdoc: "string", shared: "string[] | 'owners' | boolean" } }, Ge = { customIntegrations: { validate: na, help: ta() }, customTrayButtons: { validate: ra, help: "customTrayButtons should be a dictionary of the type ".concat(JSON.stringify(Zt)) }, url: { validate: function(r) {
  ...
  return function i(o) {
    ...
    for (var u in o) if (u === "custom") {
      ...
      var l = !a && !n.includes(u), p = !e.includes(o[u]);
      if (l || p) return !1;
    }
    return !0;
  }(r);
    ...
    switch (i) {
      ...
      case "canSend":
        if (o instanceof Set || o instanceof Array || Array.isArray(o)) {
          var a, u = ["video", "audio", "screenVideo", "screenAudio", "customVideo", "customAudio"], l = ss(o);
          try {
            for (l.s(); !(a = l.n()).done; ) {
              var p = a.value;
      ...
      case "canAdmin":
        if (o instanceof Set || o instanceof Array || Array.isArray(o)) {
          var m, g = ["participants", "streaming", "transcription"], b = ss(o);
          try {
            for (b.s(); !(m = b.n()).done; ) {
              var w = m.value;
...
var Rl = function() {
  er(ce, Me);
  var r, t, e, n, i, o, a, u, l, p, m, g, b, w, y, E, C, O, j, x, z, Y, ae, ie, ge, $e, ut, yn, _n, bn, wn, Sn, En, kn, Cn, Tn, Mn, An, ma = Dl(ce);
  function ce(s) {
    var d, c, f, h = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    if (fe(this, ce), Te(Ee(c = ma.call(this)), "startListeningForDeviceChanges", function() {
      Al(c.handleDeviceChange);
    }), Te(Ee(c), "stopListeningForDeviceChanges", function() {
      Ol(c.handleDeviceChange);
    }), Te(Ee(c), "handleDeviceChange", function(S) {
      S = S.map(function(k) {
        return JSON.parse(JSON.stringify(k));
      }), c.emitDailyJSEvent({ action: "available-devices-updated", availableDevices: S });
    }), Te(Ee(c), "handleNativeAppStateChange", function() {
      var S = P(function* (k) {
        if (k === "destroyed") return console.warn("App has been destroyed before leaving the meeting. Cleaning up all the resources!"), void (yield c.destroy());
        var A = k === "active";
        c.disableReactNativeAutoDeviceManagement("video") || (A ? c.camUnmutedBeforeLosingNativeActiveState && c.setLocalVideo(!0) : (c.camUnmutedBeforeLosingNativeActiveState = c.localVideo(), c.camUnmutedBeforeLosingNativeActiveState && c.setLocalVideo(!1)));
      });
      return function(k) {
        return S.apply(this, arguments);
      };
    }()), Te(Ee(c), "handleNativeAudioFocusChange", function(S) {
      c.disableReactNativeAutoDeviceManagement("audio") || (c._hasNativeAudioFocus = S, c.toggleParticipantAudioBasedOnNativeAudioFocus(), c._hasNativeAudioFocus ? c.micUnmutedBeforeLosingNativeAudioFocus && c.setLocalAudio(!0) : (c.micUnmutedBeforeLosingNativeAudioFocus = c.localAudio(), c.setLocalAudio(!1)));
    }), Te(Ee(c), "handleNativeSystemScreenCaptureStop", function() {
      c.stopScreenShare();
    }), c.strictMode = h.strictMode === void 0 || h.strictMode, c.allowMultipleCallInstances = (d = h.allowMultipleCallInstances) !== null && d !== void 0 && d, Object.keys(Je).length && (c._logDuplicateInstanceAttempt(), !c.allowMultipleCallInstances)) {
  ...
  return me(ce, [{ key: "destroy", value: (An = P(function* () {
    ...
    var d = s.bodyClass, c = s.cssFile, f = s.cssText;
    return D(), this.sendMessageToCallMachine({ action: "load-css", cssFile: this.absoluteUrl(c), bodyClass: d, cssText: f }), this;
    ...
    for (var c in d) {
      if (!Dt[c]) throw new Error("unrecognized updateParticipant property ".concat(c));
      if (Dt[c].validate && !Dt[c].validate(d[c], this, this._participants[s])) throw new Error(Dt[c].help);
    }
    ...
    if (le(this._callObjectMode, "updateWaitingParticipant()"), J(this._callState, "updateWaitingParticipant()"), typeof d != "string" || $(c) !== "object") throw new Error("updateWaitingParticipant() must take an id string and a updates object");
    return new Promise(function(f, h) {
      s.sendMessageToCallMachine({ action: "daily-method-update-waiting-participant", id: d, updates: c }, function(v) {
    ...
    return new Promise(function(c, f) {
      s.sendMessageToCallMachine({ action: "daily-method-update-waiting-participants", updatesById: d }, function(h) {
        h.error && f(h.error), h.ids || f(new Error("unknown error in updateWaitingParticipants()")), c({ ids: h.ids });
      });
    });
  }), function() {
    return Tn.apply(this, arguments);
  }) }, { key: "requestAccess", value: (Cn = P(function* () {
    var s = this, d = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, c = d.access, f = c === void 0 ? { level: $s } : c, h = d.name, v = h === void 0 ? "" : h;
    ...
    var d = this, c = (arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}).showInheritedValues, f = c !== void 0 && c;
    ...
    return J(this._callState, "updateReceiveSettings()", "To specify receive settings earlier, use the receiveSettings config property."), new Promise(function(c) {
      d.sendMessageToCallMachine({ action: "update-receive-settings", receiveSettings: s }, function(f) {
        c({ receiveSettings: f.receiveSettings });
      });
    });
  }), function(s) {
    ...
    if (s) {
      ...
      if (s.audio) {
        var f, h, v, S;
        s.audio.settings && (!Object.keys(s.audio.settings).length && d || (c.audio = { settings: T({}, s.audio.settings) })), d && (f = c.audio) !== null && f !== void 0 && (h = f.settings) !== null && h !== void 0 && h.customTrack && (c.audio.settings = { customTrack: this._sharedTracks.audioTrack });
        ...
        if (s.audio.processor && !k) {
          ...
          delete A._isDefaultWhenNone, c.audio = T(T({}, c.audio), {}, { processor: A });
        }
      }
      if (s.video) {
        var q, N, H, ve;
        s.video.settings && (!Object.keys(s.video.settings).length && d || (c.video = { settings: T({}, s.video.settings) })), d && (q = c.video) !== null && q !== void 0 && (N = q.settings) !== null && N !== void 0 && N.customTrack && (c.video.settings = { customTrack: this._sharedTracks.videoTrack });
        var Pe = ((H = s.video.processor) === null || H === void 0 ? void 0 : H.type) === "none" && ((ve = s.video.processor) === null || ve === void 0 ? void 0 : ve._isDefaultWhenNone);
        if (s.video.processor && !Pe) {
          var Ve = T({}, s.video.processor);
          delete Ve._isDefaultWhenNone, c.video = T(T({}, c.video), {}, { processor: Ve });
        }
      }
      return c;
    }
    ...
    var s, d, c, f, h, v, S, k, A = { processor: { type: "none", _isDefaultWhenNone: !0 } };
    this._inputSettings ? (s = ((c = this._inputSettings) === null || c === void 0 ? void 0 : c.video) || A, d = ((f = this._inputSettings) === null || f === void 0 ? void 0 : f.audio) || A) : (s = ((h = this._preloadCache) === null || h === void 0 || (v = h.inputSettings) === null || v === void 0 ? void 0 : v.video) || A, d = ((S = this._preloadCache) === null || S === void 0 || (k = S.inputSettings) === null || k === void 0 ? void 0 : k.audio) || A);
    var q = { audio: d, video: s };
    return this._prepInputSettingsForSharing(q, !0);
  } }, { key: "_updatePreloadCacheInputSettings", value: function(s, d) {
    var c = this._inputSettings || {}, f = {};
    if (s.video) {
      var h, v, S;
      f.video = {}, s.video.settings ? (f.video.settings = {}, d || s.video.settings.customTrack || (S = c.video) === null || S === void 0 || !S.settings ? f.video.settings = s.video.settings : f.video.settings = T(T({}, c.video.settings), s.video.settings), Object.keys(f.video.settings).length || delete f.video.settings) : (h = c.video) !== null && h !== void 0 && h.settings && (f.video.settings = c.video.settings), s.video.processor ? f.video.processor = s.video.processor : (v = c.video) !== null && v !== void 0 && v.processor && (f.video.processor = c.video.processor);
    } else c.video && (f.video = c.video);
    if (s.audio) {
      var k, A, q;
      f.audio = {}, s.audio.settings ? (f.audio.settings = {}, d || s.audio.settings.customTrack || (q = c.audio) === null || q === void 0 || !q.settings ? f.audio.settings = s.audio.settings : f.audio.settings = T(T({}, c.audio.settings), s.audio.settings), Object.keys(f.audio.settings).length || delete f.audio.settings) : (k = c.audio) !== null && k !== void 0 && k.settings && (f.audio.settings = c.audio.settings), s.audio.processor ? f.audio.processor = s.audio.processor : (A = c.audio) !== null && A !== void 0 && A.processor && (f.audio.processor = c.audio.processor);
    } else c.audio && (f.audio = c.audio);
    this._maybeUpdateInputSettings(f);
  } }, { key: "_devicesFromInputSettings", value: function(s) {
    var d, c, f, h, v = (s == null || (d = s.video) === null || d === void 0 || (c = d.settings) === null || c === void 0 ? void 0 : c.deviceId) || null, S = (s == null || (f = s.audio) === null || f === void 0 || (h = f.settings) === null || h === void 0 ? void 0 : h.deviceId) || null, k = this._preloadCache.outputDeviceId || null;
    return { camera: v ? { deviceId: v } : {}, mic: S ? { deviceId: S } : {}, speaker: k ? { deviceId: k } : {} };
  } }, { key: "updateInputSettings", value: (Sn = P(function* (s) {
    var d = this;
    return D(), Xo(s) ? s.video || s.audio ? (Zo(s, this.properties.dailyConfig, this._sharedTracks), this._callObjectMode && !this._callMachineInitialized ? (this._updatePreloadCacheInputSettings(s, !0), this._getInputSettings()) : new Promise(function(c, f) {
      d.sendMessageToCallMachine({ action: "update-input-settings", inputSettings: s }, function(h) {
        if (h.error) f(h.error);
        else {
          if (h.returnPreloadCache) return d._updatePreloadCacheInputSettings(s, !0), void c(d._getInputSettings());
          d._maybeUpdateInputSettings(h.inputSettings), c(d._prepInputSettingsForSharing(h.inputSettings, !0));
        }
      });
    ...
    if (D(), this._callMachineInitialized) return this.sendMessageToCallMachine({ action: "set-bandwidth", kbs: d, trackConstraints: c }), this;
    ...
    return this.properties.userName = s, new Promise(function(f) {
      c.sendMessageToCallMachine({ action: "set-user-name", name: s ?? "", thisMeetingOnly: R() || !!d && !!d.thisMeetingOnly }, function(h) {
    ...
    if (this.properties.userData = s, this._callMachineInitialized) return new Promise(function(c) {
      try {
        d.sendMessageToCallMachine({ action: "set-user-data", userData: s }, function(f) {
          delete f.action, delete f.callbackStamp, c(f);
        });
      } catch (f) {
    ...
    if (this.validateAudioLevelInterval(s), this._callMachineInitialized) return this._isLocalAudioLevelObserverRunning = !0, new Promise(function(c, f) {
      d.sendMessageToCallMachine({ action: "start-local-audio-level-observer", interval: s }, function(h) {
        d._isLocalAudioLevelObserverRunning = !h.error, h.error ? f({ error: h.error }) : c();
      });
    });
    ...
    var d = this;
    if (this.validateAudioLevelInterval(s), this._callMachineInitialized) return this._isRemoteParticipantsAudioLevelObserverRunning = !0, new Promise(function(c, f) {
      d.sendMessageToCallMachine({ action: "start-remote-participants-audio-level-observer", interval: s }, function(h) {
        d._isRemoteParticipantsAudioLevelObserverRunning = !h.error, h.error ? f({ error: h.error }) : c();
      });
    });
    ...
    return new Promise(function(c) {
      s._preloadCache.inputSettings = s._prepInputSettingsForSharing(s._inputSettings, !1), s.sendMessageToCallMachine({ action: "start-camera", properties: et(s.properties, s.callClientId), preloadCache: et(s._preloadCache, s.callClientId) }, function(f) {
        c({ camera: f.camera, mic: f.mic, speaker: f.speaker });
      });
    });
  }), function() {
    ...
    return D(), J(this._callState, "startCustomTrack()"), this.validateCustomTrack(d.track, d.mode, d.trackName), new Promise(function(c, f) {
      s._sharedTracks.customTrack = d.track, d.track = Oe, s.sendMessageToCallMachine({ action: "start-custom-track", properties: d }, function(h) {
        h.error ? f({ error: h.error }) : c(h.mediaTag);
      });
    });
  } }, { key: "stopCustomTrack", value: function(s) {
    var d = this;
    return D(), J(this._callState, "stopCustomTrack()"), new Promise(function(c) {
    ...
    var d = this;
    return ft(), Nt(this._callMachineInitialized, "setCamera()"), new Promise(function(c) {
    ...
    var d = this, c = s.audioDeviceId, f = s.videoDeviceId, h = s.audioSource, v = s.videoSource;
    if (D(), h !== void 0 && (c = h), v !== void 0 && (f = v), typeof c == "boolean" && (this._setAllowLocalAudio(c), c = void 0), typeof f == "boolean" && (this._setAllowLocalVideo(f), f = void 0), !c && !f) return yield this.getInputDevices();
    var S = {};
    return c && (c instanceof MediaStreamTrack ? (this._sharedTracks.audioTrack = c, c = Oe, S.audio = { settings: { customTrack: c } }) : (delete this._sharedTracks.audioTrack, S.audio = { settings: { deviceId: c } })), f && (f instanceof MediaStreamTrack ? (this._sharedTracks.videoTrack = f, f = Oe, S.video = { settings: { customTrack: f } }) : (delete this._sharedTracks.videoTrack, S.video = { settings: { deviceId: f } })), this._callObjectMode && this.needsLoad() ? (this._updatePreloadCacheInputSettings(S, !1), this._devicesFromInputSettings(this._inputSettings)) : new Promise(function(k) {
      d.sendMessageToCallMachine({ action: "set-input-devices", audioDeviceId: c, videoDeviceId: f }, function(A) {
    ...
    return D(), c && (this._preloadCache.outputDeviceId = c), this._callObjectMode && this.needsLoad() ? this._devicesFromInputSettings(this._inputSettings) : new Promise(function(f) {
      d.sendMessageToCallMachine({ action: "set-output-device", outputDeviceId: c }, function(h) {
    ...
    return this.validateProperties(d), this.properties = T(T({}, this.properties), d), new Promise(function(c, f) {
      s._preloadCache.inputSettings = s._prepInputSettingsForSharing(s._inputSettings, !1), s.sendMessageToCallMachine({ action: "daily-method-preauth", properties: et(s.properties, s.callClientId), preloadCache: et(s._preloadCache, s.callClientId) }, function(h) {
        return h.error ? f(h.error) : h.access ? (s._didPreAuth = !0, void c({ access: h.access })) : f(new Error("unknown error in preAuth()"));
      });
    });
  }), function() {
    ...
    if (this.needsLoad()) {
      ...
      return this._updateCallState(qi), this.emitDailyJSEvent({ action: Ws }), this._callObjectMode ? new Promise(function(c, f) {
        d._callObjectLoader.cancel();
        var h = Date.now();
        d._callObjectLoader.load(d.properties.dailyConfig, function(v) {
          d._bundleLoadTime = v ? "no-op" : Date.now() - h, d._updateCallState($i), v && d.emitDailyJSEvent({ action: Ur }), c();
        }, function(v, S) {
          if (d.emitDailyJSEvent({ action: zs }), !S) {
      ...
      }) : (this._iframe.src = Cs(this.assembleMeetingUrl(), this.properties.dailyConfig), new Promise(function(c, f) {
        d._loadedCallback = function(h) {
          d._callState !== ke ? (d._updateCallState($i), (d.properties.cssFile || d.properties.cssText) && d.loadCss(d.properties), c()) : f(h);
        };
      }));
    }
  }), function(s) {
    ...
    return d.showLocalVideo !== void 0 && (this._callObjectMode ? console.error("showLocalVideo is not available in callObject mode") : this._showLocalVideo = !!d.showLocalVideo), d.showParticipantsBar !== void 0 && (this._callObjectMode ? console.error("showParticipantsBar is not available in callObject mode") : this._showParticipantsBar = !!d.showParticipantsBar), this._callState === Ne || this._callState === Qt ? (console.warn("already joined meeting, call leave() before joining again"), void this.updateIsPreparingToJoin(!1)) : (this._updateCallState(Qt, !1), this.emitDailyJSEvent({ action: Ks }), this._preloadCache.inputSettings = this._prepInputSettingsForSharing(this._inputSettings || {}, !1), this.sendMessageToCallMachine({ action: "join-meeting", properties: et(this.properties, this.callClientId), preloadCache: et(this._preloadCache, this.callClientId) }), new Promise(function(f, h) {
      s._joinedCallback = function(v, S) {
        if (s._callState !== ke) {
          ...
          c && s.loadCss(s.properties), f(v);
        } else h(S);
      };
    }));
  }), function() {
    return Y.apply(this, arguments);
  }) }, { key: "leave", value: (z = P(function* () {
    var s = this;
    ...
    if (Nt(this._callMachineInitialized, "startScreenShare()"), d.screenVideoSendSettings && this._validateVideoSendSettings("screenVideo", d.screenVideoSendSettings), d.mediaStream && (this._sharedTracks.screenMediaStream = d.mediaStream, d.mediaStream = Oe), typeof DailyNativeUtils < "u" && DailyNativeUtils.isIOS !== void 0 && DailyNativeUtils.isIOS) {
      ...
      if (yield c.isScreenBeingCaptured()) return void this.emitDailyJSEvent({ action: Yr, type: "screen-share-error", errorMsg: "Could not start the screen sharing. The screen is already been captured!" });
      c.setSystemScreenCaptureStartCallback(function() {
        c.setSystemScreenCaptureStartCallback(null), s.sendMessageToCallMachine({ action: Ui, captureOptions: d });
    ...
    var d = s.layout, c = d === void 0 ? { preset: "default" } : d, f = s.instanceId;
    this.sendMessageToCallMachine({ action: "daily-method-update-recording", layout: c, instanceId: f });
    ...
    var d = s.layout, c = d === void 0 ? { preset: "default" } : d, f = s.instanceId;
    this.sendMessageToCallMachine({ action: "daily-method-update-live-streaming", layout: c, instanceId: f });
  } }, { key: "addLiveStreamingEndpoints", value: function(s) {
    var d = s.endpoints, c = s.instanceId;
    this.sendMessageToCallMachine({ action: Bi, endpointsOp: al, endpoints: d, instanceId: c });
  } }, { key: "removeLiveStreamingEndpoints", value: function(s) {
    var d = s.endpoints, c = s.instanceId;
    this.sendMessageToCallMachine({ action: Bi, endpointsOp: cl, endpoints: d, instanceId: c });
    ...
    if (s) {
      ...
      for (var f = 0; f < s.length; f++) {
        ...
        if (c && !h.hasOwnProperty("maxBitrate")) throw new Error("maxBitrate is not specified");
      }
    }
  } }, { key: "startRemoteMediaPlayer", value: (j = P(function* (s) {
    var d = this, c = s.url, f = s.settings, h = f === void 0 ? { state: zr.PLAY } : f;
    try {
      (function(v) {
        ...
        v.simulcastEncodings && this.validateSimulcastEncodings(v.simulcastEncodings, Ho, !0);
      }(h);
    } catch (v) {
  ...
  {state: "play"|"pause", simulcastEncodings?: [{}] } }`), v;
    ...
    return new Promise(function(v, S) {
      d.sendMessageToCallMachine({ action: "daily-method-start-remote-media-player", url: c, settings: h }, function(k) {
    ...
    return new Promise(function(c, f) {
      d.sendMessageToCallMachine({ action: "daily-method-stop-remote-media-player", session_id: s }, function(h) {
        h.error ? f({ error: h.error, errorMsg: h.errorMsg }) : c();
      });
    });
  }), function(s) {
    return O.apply(this, arguments);
  }) }, { key: "updateRemoteMediaPlayer", value: (C = P(function* (s) {
    var d = this, c = s.session_id, f = s.settings;
    try {
      fs(f);
    } catch (h) {
  ...
  { settings?: {state: "play"|"pause"} }`), h;
    ...
    return new Promise(function(h, v) {
      d.sendMessageToCallMachine({ action: "daily-method-update-remote-media-player", session_id: c, settings: f }, function(S) {
    ...
    var d = this;
    return J(this._callState, "stopDialOut()"), new Promise(function(c, f) {
      d.sendMessageToCallMachine(T({ action: "dialout-stop" }, s), function(h) {
        h.error ? f(h.error) : c(h);
      });
    });
    ...
    return s.useSipRefer = !1, hs(s, "sipCallTransfer"), new Promise(function(c, f) {
    ...
    return s.useSipRefer = !0, hs(s, "sipRefer"), new Promise(function(c, f) {
      d.sendMessageToCallMachine(T({ action: Ji }, s), function(h) {
        h.error ? f(h.error) : c(h);
      });
    });
  ...
  }) }, { key: "sendDTMF", value: (b = P(function* (s) {
    var d = this;
    return J(this._callState, "sendDTMF()"), function(c) {
      var f = c.sessionId, h = c.tones;
    ...
    var d = this._testCallAlreadyInProgress, c = function(h) {
  ...
  }) }, { key: "testPeerToPeerCallQuality", value: (l = P(function* (s) {
    var d = this;
    ...
    var c = s.videoTrack, f = s.duration;
    if (!this._validateVideoTrackForNetworkTests(c)) throw new Error("Video track error");
    return this._sharedTracks.videoTrackForConnectionQualityTest = c, new Promise(function(h, v) {
    ...
    return this._sharedTracks.videoTrackForNetworkConnectivityTest = s, new Promise(function(c, f) {
      d.sendMessageToCallMachine({ action: "test-network-connectivity" }, function(h) {
        h.error ? f(h.error) : c(h.results);
      });
    });
  }), function(s) {
    ...
    return new Promise(function(d) {
      s._callState === Ne ? s.sendMessageToCallMachine({ action: "get-cpu-load-stats" }, function(c) {
        d(c.cpuStats);
    ...
    if (typeof d == "string") {
      if (!c.includes(d)) throw new Error(f);
    } else {
    ...
    Object.entries(s).forEach(function(c) {
      var f = Se(c, 2), h = f[0], v = f[1];
      d._validateVideoSendSettings(h, v);
    });
  } }, { key: "updateSendSettings", value: function(s) {
    var d = this;
    return this.validateUpdateSendSettings(s), this.needsLoad() ? (this._preloadCache.sendSettings = s, { sendSettings: this._preloadCache.sendSettings }) : new Promise(function(c, f) {
      d.sendMessageToCallMachine({ action: "update-send-settings", sendSettings: s }, function(h) {
        h.error ? f(h.error) : c(h.sendSettings);
      });
    });
    ...
    if (this._callObjectMode) {
      ...
      return Ze() === "Firefox" && Kt().major > 115 && Kt().major < 123 && (d = d.filter(function(c) {
        return c.kind !== "audiooutput";
      })), { devices: d.map(function(c) {
        var f = JSON.parse(JSON.stringify(c));
        if (!R() && c.kind === "videoinput" && c.getCapabilities) {
          var h, v = c.getCapabilities();
    ...
    var c = typeof s == "string" ? [s] : s, f = c.filter(function(h) {
      return !(h in d._customIntegrations);
    });
    return f.length ? (console.error(`Can't find custom integration(s): "`.concat(f.join(", "), '"')), this) : (this.sendMessageToCallMachine({ action: "start-custom-integrations", ids: c }), this);
    ...
    return f.length ? (console.error(`Can't find custom integration(s): "`.concat(f.join(", "), '"')), this) : (this.sendMessageToCallMachine({ action: "stop-custom-integrations", ids: c }), this);
    ...
    var d = this;
    return re(this._callObjectMode, "setTheme()"), new Promise(function(c, f) {
      try {
    ...
    return this._accessState.access === qt || this.needsLoad() ? this.properties.url ? { roomUrlPendingJoin: this.properties.url } : null : new Promise(function(f) {
      s.sendMessageToCallMachine({ action: "lib-room-info", includeRoomConfigDefaults: c }, function(h) {
        delete h.action, delete h.callbackStamp, f(h);
      });
    });
  }), function() {
    ...
    var d = this;
    return D(), J(this._callState, "setNetworkTopology()"), new Promise(function(c, f) {
      d.sendMessageToCallMachine({ action: "set-network-topology", opts: s }, function(h) {
        h.error ? f({ error: h.error }) : c({ workerId: h.workerId });
      });
    });
  }), function(s) {
    return t.apply(this, arguments);
    ...
    return new Promise(function(d, c) {
      s.needsLoad() && d({ topology: "none" }), s.sendMessageToCallMachine({ action: "get-network-topology" }, function(f) {
        f.error ? c({ error: f.error }) : d({ topology: f.topology });
      });
    });
  }), function() {
    return r.apply(this, arguments);
    ...
    for (var H in s) {
      if (!Ge[H]) throw new Error("unrecognized property '".concat(H, "'"));
      if (Ge[H].validate && !Ge[H].validate(s[H], this)) throw new Error("property '".concat(H, "': ").concat(Ge[H].help));
    }
  } }, { key: "assembleMeetingUrl", value: function() {
    var s, d, c = T(T({}, this.properties), {}, { emb: this.callClientId, embHref: encodeURIComponent(window.location.href), proxy: (s = this.properties.dailyConfig) !== null && s !== void 0 && s.proxyUrl ? encodeURIComponent((d = this.properties.dailyConfig) === null || d === void 0 ? void 0 : d.proxyUrl) : void 0 }), f = c.url.match(/\?/) ? "&" : "?";
    return c.url + f + Object.keys(Ge).filter(function(h) {
      return Ge[h].queryString && c[h] !== void 0;
    }).map(function(h) {
      return "".concat(Ge[h].queryString, "=").concat(c[h]);
    }).join("&");
    ...
    switch (s.action) {
      ...
      case Xs:
        var c, f = T({}, s);
        delete f.internal, this._maxAppMessageSize = ((c = s.internal) === null || c === void 0 ? void 0 : c._maxAppMessageSize) || mr, this._joinedCallback && (this._joinedCallback(s.participants), this._joinedCallback = null), this.emitDailyJSEvent(f);
        break;
      case eo:
      case to:
      ...
      case "selected-devices-updated":
        ...
        break;
      case Po:
        var H = s.threshold, ve = s.quality;
        H === this._network.threshold && ve === this._network.quality || (this._network.quality = ve, this._network.threshold = H, this.emitDailyJSEvent(s));
        break;
      case Io:
    ...
    var c = "record";
    s && (d.local || d[c] !== !1 || s[c] === d[c] || this.emitDailyJSEvent({ action: Jr }));
  } }, { key: "maybeEventRecordingStarted", value: function(s, d) {
    var c = "record";
    s && (d.local || d[c] !== !0 || s[c] === d[c] || this.emitDailyJSEvent({ action: Br }));
    ...
    var f, h, v = (f = d == null ? void 0 : d.tracks[s]) !== null && f !== void 0 ? f : null, S = (h = c == null ? void 0 : c.tracks[s]) !== null && h !== void 0 ? h : null, k = v == null ? void 0 : v.track;
    if (k) {
      var A = this._trackStatePlayable(v), q = this._trackStatePlayable(S), N = this._trackChanged(k, S == null ? void 0 : S.track);
      A && (q && !N || this.emitDailyJSEvent({ action: po, track: k, participant: c ?? d, type: s }));
    }
  } }, { key: "maybeEventTrackStarted", value: function(s, d, c) {
    var f, h, v = (f = d == null ? void 0 : d.tracks[s]) !== null && f !== void 0 ? f : null, S = (h = c == null ? void 0 : c.tracks[s]) !== null && h !== void 0 ? h : null, k = S == null ? void 0 : S.track;
    if (k) {
      var A = this._trackStatePlayable(v), q = this._trackStatePlayable(S), N = this._trackChanged(v == null ? void 0 : v.track, k);
      q && (A && !N || this.emitDailyJSEvent({ action: uo, track: k, participant: c, type: s }));
    }
    ...
    var c, f;
    return s.state === d.state && ((c = s.settings) === null || c === void 0 ? void 0 : c.volume) === ((f = d.settings) === null || f === void 0 ? void 0 : f.volume);
    ...
    if (R() && this.nativeUtils().setShowOngoingMeetingNotification) {
      ...
      if (this.properties.reactNativeConfig && this.properties.reactNativeConfig.androidInCallNotification) {
        ...
        d = v.title, c = v.subtitle, f = v.iconName, h = v.disableForCustomOverride;
      }
      h && (s = !1), this.nativeUtils().setShowOngoingMeetingNotification(s, d, c, f, this.callClientId);
    }
    ...
    var s, d;
    if (R()) {
      var c = (s = this._callMachine()) === null || s === void 0 || (d = s.store) === null || d === void 0 ? void 0 : d.getState();
      for (var f in c == null ? void 0 : c.streams) {
        var h = c.streams[f];
    ...
    if (this.needsLoad())
      ...
      var c = { action: It, level: "error", code: this.strictMode ? 9995 : 9997 };
    ...
    for (var s = 0, d = Object.values(Je); s < d.length; s++) {
      var c = d[s];
      c._callMachineInitialized ? (c.sendMessageToCallMachine({ action: It, level: "warn", code: this.allowMultipleCallInstances ? 9993 : 9992 }), c._delayDuplicateInstanceLog = !1) : c._delayDuplicateInstanceLog = !0;
    }
    ...
    if (!((d = s.error) !== null && d !== void 0 && d.type && (![Bs, Us, Vr].includes(s.error.type) || s.error.type === Vr && s.error.msg.includes("deleted")))) {
      var k = (c = this.properties) !== null && c !== void 0 && c.url ? new URL(this.properties.url) : void 0, A = "production";
      k && k.host.includes(".staging.daily") && (A = "staging");
      var q, N, H, ve, Pe, Ve = [uc(), cc(), Pc(), Ac(), Dc(), Rc(), dc(), Nc()].filter(function(ga) {
    ...
    if (!ee(this._inputSettings, s)) {
      ...
      ee(d, c) || this.emitDailyJSEvent({ action: Gr, inputSettings: c });
    }
    ...
    var c, f;
    D(), s && d ? (c = s, f = d) : s && s.append ? (c = s, f = {}) : (c = document.body, f = s || {});
    var h = f.iframeStyle;
    h || (h = c === document.body ? { position: "fixed", border: "1px solid black", backgroundColor: "white", width: "375px", height: "450px", right: "1em", bottom: "1em" } : { border: 0, width: "100%", height: "100%" });
    var v = document.createElement("iframe");
    window.navigator && window.navigator.userAgent.match(/Chrome\/61\./) ? v.allow = "microphone, camera" : v.allow = "microphone; camera; autoplay; display-capture; screen-wake-lock", v.style.visibility = "hidden", c.appendChild(v), v.style.visibility = null, Object.keys(h).forEach(function(S) {
      return v.style[S] = h[S];
    }), f.layout || (f.customLayout ? f.layout = "custom-v1" : f.layout = "browser");
    try {
      return new ce(v, f);
    } catch (S) {
      throw c.removeChild(v), S;
    }
...
function Ko(r, t) {
  for (var e = t.allowAllParticipantsKey, n = function(g) {
    var b = ["local"];
    return e || b.push("*"), g && !b.includes(g);
  }, i = function(g) {
...
function Xo(r) {
  ...
  for (var t = 0, e = Object.entries(r); t < e.length; t++) {
    ...
    switch (i) {
      ...
      case "audio":
        if ($(o) !== "object") return !1;
        for (var g = 0, b = Object.entries(o); g < b.length; g++) {
          var w = Se(b[g], 2), y = w[0], E = w[1];
          switch (y) {
            case "processor":
              if (!xl(E)) return !1;
              break;
        ...
        return !(n.source !== void 0 && !function(a) {
          ...
          if (Jt(a.source)) return a.type = "url", !!function(p) {
            ...
            if (m.protocol === "data:") try {
              var b = g.substring(g.indexOf(":") + 1, g.indexOf(";")).split("/")[1];
              return vr.includes(b);
            } catch (y) {
          ...
          return u = a.source, l = Number(u), isNaN(l) || !Number.isInteger(l) || l <= 0 || l > 10 ? (console.error("invalid image selection; must be an int, > 0, <= ".concat(10)), !1) : (a.type = "daily-preselect", !0);
          var u, l;
        }(n));
      default:
        return !0;
...
function ra(r) {
  ...
  if (r) for (var t = 0, e = Object.entries(r); t < e.length; t++) for (var n = Se(e[t], 1)[0], i = 0, o = Object.entries(r[n]); i < o.length; i++) {
    var a = Se(o[i], 2), u = a[0], l = a[1], p = Zt.id[u];
    if (!p) return console.error("customTrayButton does not support key ".concat(u)), !1;
    switch (u) {
      case "iconPath":
      case "iconPathDarkMode":
        if (!Jt(l)) return console.error("customTrayButton ".concat(u, " should be a url.")), !1;
        break;
      case "visualState":
        if (!["default", "sidebar-open", "active"].includes(l)) return console.error("customTrayButton ".concat(u, " should be ").concat(p, ". Got: ").concat(l)), !1;
        break;
      default:
        if ($(l) !== p) return console.error("customTrayButton ".concat(u, " should be a ").concat(p, ".")), !1;
    }
  }
  return !0;
}
function na(r) {
  ...
  for (var t = function(g) {
    ...
    return console.error("customIntegration ".concat(g, ": ").concat(b));
...
function fs(r) {
  ...
  if (r.state && !Object.values(zr).includes(r.state)) throw new Error("Invalid value for RemoteMediaPlayerSettings.state, valid values are: " + JSON.stringify(zr));
  if (r.volume) {
...
const ql = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  DAILY_EVENT_LOAD_ATTEMPT_FAILED: zs,
...
U.prototype.emit = function(t) {
  ...
  if (typeof l == "function")
    ...
    for (var p = l.length, m = da(l, p), n = 0; n < p; ++n)
      gs(m[n], this, e);
  return !0;
};
function aa(r, t, e, n) {
...
class ha {
  constructor(t = {}) {
    ...
    I(this, "request", async ({ body: t, secure: e, path: n, type: i, query: o, format: a, baseUrl: u, cancelToken: l, ...p }) => {
      const m = (typeof e == "boolean" ? e : this.baseApiParams.secure) && this.securityWorker && await this.securityWorker(this.securityData) || {}, g = this.mergeRequestParams(p, m), b = o && this.toQueryString(o), w = this.contentFormatters[i || M.Json], y = a || g.format;
      return this.customFetch(`${u || this.baseUrl || ""}${n}${b ? `?${b}` : ""}`, {
        ...g,
        headers: {
          ...g.headers || {},
          ...i && i !== M.FormData ? { "Content-Type": i } : {}
        },
        signal: (l ? this.createAbortSignal(l) : g.signal) || null,
        ...
        if (l && this.abortControllers.delete(l), !E.ok)
          throw O;
        return O;
      });
    });
...
class iu extends nu {
  ...
  async start(e, n, i) {
    ...
    this.started = !0;
    try {
      const l = (await kr.client.call.callControllerCreateWebCall({
      ...
      const p = ((o = l == null ? void 0 : l.artifactPlan) == null ? void 0 : o.videoRecordingEnabled) ?? !1, m = ((a = l.transport) == null ? void 0 : a.assistantVideoEnabled) ?? !1;
      if (this.call = Kl.default.createCallObject({
        ...
        var b;
        this.emit("error", g), p && ((b = this.call) == null || b.stopRecording());
      }), this.call.on("camera-error", (g) => {
        this.emit("error", g);
      }), this.call.on("track-started", async (g) => {
        var b, w, y;
        !g || !g.participant || (b = g.participant) != null && b.local || ((w = g.participant) == null ? void 0 : w.user_name) === "Vapi Speaker" && (g.track.kind === "video" && this.emit("video", g.track), g.track.kind === "audio" && await eu(g.track, g.participant.session_id), (y = this.call) == null || y.sendAppMessage("playable"));
      ...
      return this.call.startRemoteParticipantsAudioLevelObserver(100), this.call.on("remote-participants-audio-level", (g) => {
        ...
        var b;
        (g == null ? void 0 : g.type) === "audio-processor-error" && ((b = this.call) == null || b.updateInputSettings({
          audio: {
            processor: {
              type: "none"
            }
  ...
  async increaseMicLevel(e) {
    ...
    try {
      ...
      a.connect(u);
      const [l] = u.stream.getAudioTracks();
      await this.call.setInputDevicesAsync({ audioSource: l });
    } catch (n) {
...
const ou = ({
  ...
  const u = parseInt(n) / 2, l = parseInt(i) / 2, p = {
    ...
    right: `top: 50%; right: ${a}; margin-top: -${l}px;`,
    left: `top: 50%; left: ${a}; margin-top: -${l}px;`,
  ...
  return l.id = u, l.className = "vapi-btn vapi-btn-round vapi-btn-is-idle", l.onclick = () => {
  }, l;
  ...
  if (n) {
    if (t.className = `vapi-btn vapi-btn-is-${e} ${n.type === "pill" ? "vapi-btn-pill" : n.type === "round" ? "vapi-btn-round" : ""}`, t.innerHTML = "", t.title = n.title ?? "", n.type === "pill") {
      ...
      l.id = "vapi-subtitle", l.textContent = n.subtitle, a.appendChild(u), a.appendChild(l), t.appendChild(i), t.appendChild(a);
...
function lu(r, t, e, n, i, o) {
  ...
  }), t.addEventListener("click", u), r.on("volume-level", (l) => {
...
const uu = ({
  ...
  function u(m, g) {
    ...
    return Object.keys(g).forEach((w) => {
      typeof g[w] == "object" && g[w] !== null && !Array.isArray(g[w]) ? b[w] = u(
        m[w] || {},
        g[w]
      ) : b[w] = g[w];
    }), b;
  ...
  if (r && (t || n)) {
    ...
    if (o) {
      const g = au(p), b = cu(p);
      document.body.appendChild(g), b(g, "idle"), lu(m, g, t, e, n, b);
    }
    return window.vapiSDK.vapi = m, m;
  } else
